...
@SqlResultSetMapping(name = "FindAllWithSimilarClientNameMappingDescending",
        classes = {
                @ConstructorResult(
                        ...
                        targetClass = FiledTicketWithUserNameDescending.class
                )})
public class FiledTicketWithUserNameDescending extends AbstractTicketWithUserName{

    public FiledTicketWithUserNameDescending(Long ticketId, String clientName, Long clientId, LocalDateTime ticketTs, String ticketStatus) {
        super(ticketId, clientName, clientId, ticketTs, ticketStatus);
    }

    public FiledTicketWithUserNameDescending(){
        super();
    };
}
